...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void busyOptionalAttendeeNotConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events   :       |--A--|     |--B--|
  ...
  public void allOptional() {
    ...
    Collection<Event> events =
        Arrays.asList(
            new Event(
                "Event 1",
                TimeRange.fromStartDuration(TIME_0800AM, DURATION_1_HOUR),
                Arrays.asList(PERSON_A)),
            new Event(
                "Event 2",
            ...
            new Event(
                "Event 4",
                TimeRange.fromStartDuration(TIME_1200PM, DURATION_1_HOUR),
                Arrays.asList(PERSON_A)));
    ...
    Collection<TimeRange> expected =
        Arrays.asList(
            ...
            TimeRange.fromStartDuration(TIME_1100AM, DURATION_1_HOUR),
  ...
  public void allOptionalNoGaps() {
    ...
    MeetingRequest request = new MeetingRequest(NO_ATTENDEES, DURATION_31_MINUTES);
    request.addOptionalAttendee(PERSON_A);
    request.addOptionalAttendee(PERSON_B);
  ...
  @Test
  public void justEnoughRoomMixed() {
    // Events   : |--A--|
    // Optional :             |----B----|
    // Day      : |---------------------|
    // Options  :       |-----|
